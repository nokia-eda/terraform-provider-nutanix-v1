...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-nutanix/internal/eda/utils"
...
var _ provider.Provider = (*nutanixProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &nutanixProvider{version: ver}
	}
}
...
func (p *nutanixProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *nutanixProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *nutanixProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "nutanix-v1"
